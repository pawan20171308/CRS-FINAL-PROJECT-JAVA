...
/*
 *  this class will hold functions for ProfessorDaoInterface Implementation
 * examples include selectCourse(int courseId ,Proffessor professor),
 * deselectCourse(int courseId, Proffessor professor),
 * displaySelectedCoursesProfessor(Proffessor professor)
 */
