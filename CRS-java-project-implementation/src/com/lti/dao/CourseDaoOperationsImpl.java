...
/**
 * this class will hold functions for CourseDaoInterface Implementation
 * examples include displayCourses(Student student),insertCourse(Course course),deleteCourse(int courseId)
 *
 */
