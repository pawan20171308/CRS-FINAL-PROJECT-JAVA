...
/**
 * this class will hold functions for GradeDaoInterface Implementation
 * examples include displayGrades(Student student),
 * uploadGrades(int studentId, int courseId, String grade)
 *
 */
